//NGIIS FILE
//Copied from mpeg4videoenc.c which provides an example of defining a "FFCodec"


#include "mpeg4rawenc.h"
...
const FFCodec ff_mpeg4_raw_encoder = {
    ...
    .p.id           = AV_CODEC_ID_RAW_MP4,
    // .p.id           = AV_CODEC_ID_MPEG4,
    // .p.id           = AV_CODEC_ID_RAWVIDEO,
    .priv_data_size = sizeof(MpegEncContext),
    .init           = encode_init,
    FF_CODEC_ENCODE_CB(ff_ngiis_encode_picture),
    // FF_CODEC_ENCODE_CB(ff_mpv_encode_picture),
    .close          = ff_mpv_encode_end,
    .p.pix_fmts     = (const enum AVPixelFormat[]) { AV_PIX_FMT_YUV420P, AV_PIX_FMT_RGB24, AV_PIX_FMT_NONE },
